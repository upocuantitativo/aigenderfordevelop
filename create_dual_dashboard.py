...
# -*- coding: utf-8 -*-
"""
Create Dual Target Dashboard for GDP Growth + Ease of Doing Business
...
ease_res = dual_results['Ease_of_Business']
...
desc_stats = df[predictors + ['G_GPD_PCAP_SLOPE', 'Ease of Doing Business']].describe().T

# Load SHAP importance for GDP Growth
try:
    shap_gdp = pd.read_csv('resultados/top_15_shap_importance.csv')
except:
...
<head>
    ...
    <title>Dual Target Analysis - GDP Growth & Ease of Doing Business</title>
    <style>
...
<body>
    <div class="header">
        <h1>Dual Target Analysis - Entrepreneurship & Gender Indicators</h1>
        <div class="subtitle">
            GDP Growth + Ease of Doing Business | 52 Countries | 131 Variables<br>
    ...
    <div class="tab-content" id="tab-0">
        ...
        <div class="dual-target-box">
            ...
            <div class="target-panel poor">
                <h3 style="margin-top: 0; color: #c62828;">Target 2: Ease of Doing Business ✗</h3>
                <strong>Variable:</strong> Ease of Doing Business<br>
                ...
                The Ease of Doing Business may not be well-predicted by gender indicators alone.
                </p>
            </div>
        </div>
...
html += """        </table>
        ...
        <h2>Ease of Doing Business - Model Comparison (Top 3)</h2>
        <table>
            <tr>
                <th style="width: 40px;">Rank</th>
                <th>Model</th>
...
html += """        </table>
        <p class="note">Note: All models for Ease of Doing Business show poor performance (negative R²), indicating that gender indicators alone may not adequately predict this outcome.</p>

        <h2>SHAP Feature Importance - GDP Growth</h2>
        <p>Click image to enlarge.</p>
        <img src="graficos_finales/shap_GDP_Growth.png" alt="SHAP GDP Growth" onclick="openModal(this)">

        <h2>SHAP Feature Importance - Ease of Doing Business</h2>
        <p>Click image to enlarge.</p>
        <img src="graficos_finales/shap_Ease_of_Business.png" alt="SHAP Ease of Business" onclick="openModal(this)">

        <h2>Robustness Analysis - GDP Growth</h2>
        <p>Comprehensive validation diagnostics. Click to enlarge.</p>
        <img src="graficos_finales/robustness_GDP_Growth.png" alt="Robustness GDP" onclick="openModal(this)">
        ...
        <img src="graficos_finales/residual_details_GDP_Growth.png" alt="Residual Details GDP" onclick="openModal(this)" style="margin-top: 10px;">
        ...
        <h2>Robustness Analysis - Ease of Doing Business</h2>
        <p>Diagnostic plots for Ease of Business model (note poor model fit). Click to enlarge.</p>
        <img src="graficos_finales/robustness_Ease_of_Business.png" alt="Robustness Ease" onclick="openModal(this)">
        <img src="graficos_finales/residual_details_Ease_of_Business.png" alt="Residual Details Ease" onclick="openModal(this)" style="margin-top: 10px;">
        ...
        <h2>Validation Statistics - Ease of Doing Business</h2>
        <table>
            <tr><th>Test</th><th>Value</th><th>Interpretation</th></tr>
            <tr>
                <td>Shapiro-Wilk</td>
...
html += """        </table>
    ...
    <div class="tab-content active" id="tab-2">
        ...
        <p>Adjust key variables to see projected impact on <strong>both GDP Growth and Ease of Doing Business</strong>.</p>

        <div class="summary">
            <strong>Instructions:</strong> Move sliders below to adjust variable values. The projection shows changes
            for both target variables simultaneously. GDP Growth model is reliable (R²=0.73), while Ease of Business
            ...
            <div class="projection-column">
                <div class="projection-result">
                    ...
                    <div class="note" style="margin-top: 10px;">
                        ...
                        <strong>Orange bars:</strong> Ease of Doing Business (caution: poor model fit)
                    </div>
                </div>
            </div>
        </div>
...
html += """            </ul>
            ...
            <strong>Important:</strong> Ease of Doing Business predictions are shown but should be interpreted with extreme caution due to poor model performance.
    ...
    <script>
        ...
        function drawDualChart(gdpBase, gdpProj, easeBase, easeProj) {
            ...
            ctx.fillText('Ease of Business', easeCenterX, baseY + 40);
        ...
        function updateProjections() {
            ...
            // Ease of Business gets smaller influence (poor model)
...
print("\nFeatures:")
print("  - Dual target analysis (GDP Growth + Ease of Doing Business)")
