...
with open('resultados/modelos/final_dual_target_results.pkl', 'rb') as f:
...
try:
    shap_gdp = pd.read_csv('resultados/top_15_shap_importance_GDP_Growth.csv')
except:
...
<body>
    <div class="header">
        <h1>Final Dual Target Analysis - Gender & Entrepreneurship</h1>
        <div class="subtitle">
...
html += """        </table>
        ...
        <p>Click image to enlarge.</p>
        <img src="graficos_finales/shap_Trading_Score.png" alt="SHAP Trading Score" onclick="openModal(this)">
        ...
        <img src="graficos_finales/robustness_Trading_Score.png" alt="Robustness Ease" onclick="openModal(this)">
        <img src="graficos_finales/residual_details_Trading_Score.png" alt="Residual Details Ease" onclick="openModal(this)" style="margin-top: 10px;">

        <h2>Cluster Analysis</h2>
        <p>Country groupings based on gender and development indicators. Click to enlarge.</p>
        <img src="graficos_finales/cluster_analysis_final.png" alt="Cluster Analysis" onclick="openModal(this)">
