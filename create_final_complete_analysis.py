...
for target_name in ['GDP_Growth', 'Trading_Score']:
    ...
    plt.tight_layout()
    plt.savefig(f'resultados/graficos_finales/robustness_{target_name}.png', dpi=200, bbox_inches='tight')
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(f'resultados/graficos_finales/residual_details_{target_name}.png', dpi=200, bbox_inches='tight')
    plt.close()
...
cluster_df.to_csv('resultados/cluster_assignments_final.csv', index=False)
...
plt.tight_layout()
plt.savefig('resultados/graficos_finales/cluster_analysis_final.png', dpi=200, bbox_inches='tight')
plt.close()
...
print("  - robustness_Trading_Score.png")
print("  - residual_details_GDP_Growth.png")
print("  - residual_details_Trading_Score.png")
print("  - cluster_analysis_final.png")
