...
# -*- coding: utf-8 -*-
"""
Dual Target Analysis: GDP Growth + Ease of Doing Business
Complete analysis with Random Forest for both targets
"""
...
print(f"\nData loaded: {df.shape[0]} countries, {df.shape[1]} variables")
...
for target_name, target_col in targets.items():
    ...
    # Get predictors (exclude targets and identifiers)
    exclude_cols = list(targets.values()) + ['Country', 'country', 'Country Name', 'COUNTRY']
    ...
    # 1. Random Forest with recursive optimization
...
# Save results
with open('resultados/modelos/dual_target_results.pkl', 'wb') as f:
...
print(f"\nResults saved: resultados/modelos/dual_target_results.pkl")
